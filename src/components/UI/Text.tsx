  ...
  (props, ref) => {
    ...
    if (as === "h1") {
      return (
        <h1
          ref={ref}
          className={cn(
            "font-Segoe text-[60px] font-bold text-primary leading-[66px] mob:text-[45px]",
            className
          )}
          onClick={onclick}
          style={Style}
    ...
    if (as === "h2") {
      return (
        <h2
          ref={ref}
          className={cn(
            "font-Segoe text-[48px] font-semibold text-primary leading-[48px] mob:text-[35px]",
            className
          )}
          onClick={onclick}
        >
    ...
    return (
      <p
        ref={ref}
        className={cn(
          "font-Segoe text-[16px] font-normal text-[#30434D]",
          className
        )}
        onClick={onclick}
      >
