  ...
  return (
    ...
    >
      ...
      <svg
        ...
        height="110"
        fill="none"
        className="fill-white transition-all relative group-hover:scale-[1.45] duration-1000 group-hover:fill-[#1196CD] group-hover:z-[100]"
      ...
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="absolute  stroke-[#88CCE7] group-hover:stroke-white group-hover:scale-[1.45] transition-all group-hover:z-[100] duration-1000"
      >
        <path
