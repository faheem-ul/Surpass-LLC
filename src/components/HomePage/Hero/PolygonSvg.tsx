...
const PolygonSvg: React.FC<Props> = ({ text, onClick }) => {
  ...
  return (
    ...
    >
      ...
      <svg
        fill="none"
        className="fill-white transition-all w-[97px] h-[97px] relative group-hover:scale-[1.45] duration-1000 group-hover:fill-[#1196CD] group-hover:z-[100] origin-center"
      ...
      <svg
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="absolute hover:origin-center stroke-[#88CCE7] top-[-1.5px] left-[6.4px] group-hover:left-[9%] group-hover:top-[-3%] w-[94px] h-[94px] group-hover:stroke-white group-hover:scale-[1.45] transition-all group-hover:z-[100] duration-1000"
        viewBox="0 0 120 100"
      >
        <path
      ...
      <div className="absolute w-full h-full top-[-5px] flex justify-center items-center left-[0px] px-[22px]">
        <Text className="text-[10px] group-hover:text-white font-Segoe transition-all leading-[13px] font-semibold group-hover:scale-[1.45] group-hover:z-[100] duration-1000 text-center text-black">
          {text}
        </Text>
      </div>
    </div>
