  ...
  return (
    ...
    >
      ...
      <svg
        ...
        height="110"
        fill="none"
        className="fill-white transition-all relative group-hover:scale-[1.45] duration-1000 group-hover:fill-[#1196CD] group-hover:z-10"
      ...
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="absolute  stroke-[#88CCE7] group-hover:stroke-white group-hover:scale-[1.45] transition-all group-hover:z-10 duration-1000"
      >
        <path
      ...
      <div className="absolute w-full h-full top-[3px] flex justify-center items-center left-[-1px] px-5">
        <Text className="text-[11px] font-medium group-hover:text-white transition-all group-hover:scale-[1.45] group-hover:z-10 duration-1000 text-center text-black">
          {text}
        </Text>
      </div>
    </div>
